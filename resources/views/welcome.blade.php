...
<body>
                            ...
                            @auth
                                <li class="scroll-to-section">
                                    <a 
                                      ...
                                      class="btn btn-primary border border-info pt-0 animate__animated animate__pulse animate__infinite	infinite"
                                    >
                                        Dashboard
                                    </a>
                                </li>
                                @else
                                <li class="scroll-to-section">
                                    <a href="{{ route('login') }}" class="btn btn-primary pt-0">
                                        Log in
                                    </a>
                                </li>
                                ...
                                @if (Route::has('register'))
                                    <li class="scroll-to-section">
                                        <a href="{{ route('register') }}" class="btn btn-primary pt-0">
                                            Register
                                        </a>
                                    </li>
                                @endif
      ...
      <div class="row event_box">
        <div class="col-lg-4 col-md-6 align-self-center mb-30 event_outer col-md-6 design">
          <div class="events_item">
            <div class="thumb">
              <a href="#"><img src="{{ asset('assets') }}/images/course-01.jpg" alt=""></a>
        ...
        <div class="col-lg-4 col-md-6 align-self-center mb-30 event_outer col-md-6  development">
          <div class="events_item">
            <div class="thumb">
              <a href="#"><img src="{{ asset('assets') }}/images/course-02.jpg" alt=""></a>
        ...
        <div class="col-lg-4 col-md-6 align-self-center mb-30 event_outer col-md-6 design wordpress">
          <div class="events_item">
            <div class="thumb">
              <a href="#"><img src="{{ asset('assets') }}/images/course-03.jpg" alt=""></a>
        ...
        <div class="col-lg-4 col-md-6 align-self-center mb-30 event_outer col-md-6 development">
          <div class="events_item">
            <div class="thumb">
              <a href="#"><img src="{{ asset('assets') }}/images/course-04.jpg" alt=""></a>
              <span class="category">Development</span>
        ...
        <div class="col-lg-4 col-md-6 align-self-center mb-30 event_outer col-md-6 wordpress development">
          <div class="events_item">
            <div class="thumb">
              <a href="#"><img src="{{ asset('assets') }}/images/course-05.jpg" alt=""></a>
              <span class="category">Wordpress</span>
        ...
        <div class="col-lg-4 col-md-6 align-self-center mb-30 event_outer col-md-6 wordpress design">
          <div class="events_item">
            <div class="thumb">
              <a href="#"><img src="{{ asset('assets') }}/images/course-06.jpg" alt=""></a>
              <span class="category">Webdesign</span>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-3 col-md-6">
          <div class="team-member">
            <div class="main-content">
              <img src="{{ asset('assets') }}/images/member-04.jpg" alt="">
  ...
  <footer>
    <div class="container">
      <div class="col-lg-12">
        <p>Copyright © 2024 eLearning Organization. All rights reserved. Design: <a href="https://templatemo.com" rel="nofollow" target="_blank">TemplateMo</a> Distribution: <a href="https://themewagon.com" rel="nofollow" target="_blank">ThemeWagon</a></p>
      </div>
    </div>
  </footer>
